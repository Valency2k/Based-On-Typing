...
const ACHIEVEMENTS = [
    { id: 1, name: "First Steps", description: "Complete your first game", image: "/achievements/1.png" },
    { id: 2, name: "Speed Demon", description: "Reach 80 WPM", image: "/achievements/2.png" },
    { id: 3, name: "Perfectionist", description: "100% Accuracy", image: "/achievements/3.png" },
    { id: 4, name: "Marathon Runner", description: "Type 500 words total", image: "/achievements/4.png" },
    { id: 5, name: "Survivor", description: "Reach Level 5 in Survival", image: "/achievements/5.png" },
